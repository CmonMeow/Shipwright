...
uint32_t Fault_ConvertAddress(FaultAddrConvClient*);
void Fault_Sleep(uint32_t);
void Fault_PadCallback(Input*);
void Fault_UpdatePadImpl();
uint32_t Fault_WaitForInputImpl();
void Fault_WaitForInput();
void Fault_DrawRec(int32_t, int32_t, int32_t, int32_t, uint16_t);
void Fault_FillScreenBlack();
void Fault_FillScreenRed();
void Fault_DrawCornerRec(uint16_t);
void Fault_PrintFReg(int32_t, float*);
void Fault_LogFReg(int32_t, float*);
void Fault_PrintFPCR(uint32_t);
void Fault_LogFPCR(uint32_t);
...
void Fault_DrawMemDumpPage(const char*, uint32_t*, uint32_t);
void Fault_DrawMemDump(uint32_t, uint32_t, uint32_t, uint32_t);
