...
Drum* ResourceMgr_LoadAudioDrumSampleByName(const char* path, int32_t drumIndex);
Instrument* ResourceMgr_LoadAudioInstrumentSamplesByName(const char* path, int32_t instrumentIndex);
SoundFontSound* ResourceMgr_LoadAudioSoundEffectSampleByName(const char* path, int32_t soundEffectIndex);
