...
ResourceFactoryBinaryCollisionHeaderV0::ReadResource(std::shared_ptr<Engine::File> file,
...
std::shared_ptr<Engine::IResource>
ResourceFactoryXMLCollisionHeaderV0::ReadResource(std::shared_ptr<Engine::File> file,
                                                  std::shared_ptr<Engine::ResourceInitData> initData) {
    if (!FileHasValidFormatAndReader(file, initData)) {
        return nullptr;
    }
