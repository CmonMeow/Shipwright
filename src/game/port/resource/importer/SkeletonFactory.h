...
namespace SOH {
class ResourceFactoryBinarySkeletonV0 final : public Engine::ResourceFactoryBinary {
  public:
...
class ResourceFactoryXMLSkeletonV0 final : public Engine::ResourceFactoryXML {
  public:
    std::shared_ptr<Engine::IResource> ReadResource(std::shared_ptr<Engine::File> file,
                                                  std::shared_ptr<Engine::ResourceInitData> initData) override;
};
