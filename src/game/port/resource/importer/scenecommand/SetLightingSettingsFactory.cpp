...
#include "port/resource/type/scenecommand/SetLightingSettings.h"
#include <tinyxml2.h>

namespace SOH {
std::shared_ptr<Engine::IResource>
SetLightingSettingsFactory::ReadResource(std::shared_ptr<Engine::ResourceInitData> initData,
...
std::shared_ptr<Engine::IResource>
SetLightingSettingsFactoryXML::ReadResource(std::shared_ptr<Engine::ResourceInitData> initData,
