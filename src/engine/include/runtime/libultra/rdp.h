...
#define DPC_START_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x00))
#define DPC_END_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x04))
#define DPC_CURRENT_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x08))
#define DPC_STATUS_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x0C))
#define DPC_CLOCK_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x10))
#define DPC_BUFBUSY_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x14))
#define DPC_PIPEBUSY_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x18))
#define DPC_TMEM_REG (*(volatile uint32_t*)(DPC_REG_BASE + 0x1C))

/* DP Span Registers */

#define DPS_REG_BASE 0xA4200000

#define DPS_TBIST_REG (*(volatile uint32_t*)(DPS_REG_BASE + 0x00))
#define DPS_TEST_MODE_REG (*(volatile uint32_t*)(DPS_REG_BASE + 0x04))
#define DPS_BUFTEST_ADDR_REG (*(volatile uint32_t*)(DPS_REG_BASE + 0x08))
#define DPS_BUFTEST_DATA_REG (*(volatile uint32_t*)(DPS_REG_BASE + 0x0C))
