...
typedef struct {
    ...
    /* 0x10 */ uint32_t hSync;
    /* 0x14 */ uint32_t leap;
    /* 0x18 */ uint32_t hStart;
    /* 0x1C */ uint32_t xScale;
    /* 0x20 */ uint32_t vCurrent;
} OSViCommonRegs; // size = 0x20

typedef struct {
    /* 0x00 */ uint32_t origin;
    /* 0x04 */ uint32_t yScale;
    /* 0x08 */ uint32_t vStart;
    /* 0x0C */ uint32_t vBurst;
    /* 0x10 */ uint32_t vIntr;
