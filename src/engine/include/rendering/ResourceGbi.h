...
// Custom resource commands. Values are persisted in display-list resources.
constexpr int8_t RESOURCE_G_SETTIMG_HASH = OPCODE(0x20);
constexpr int8_t RESOURCE_G_SETFB = OPCODE(0x21);
constexpr int8_t RESOURCE_G_RESETFB = OPCODE(0x22);
constexpr int8_t RESOURCE_G_SETTIMG_FB = OPCODE(0x23);
constexpr int8_t RESOURCE_G_VTX_PATH = OPCODE(0x24);
constexpr int8_t RESOURCE_G_SETTIMG_PATH = OPCODE(0x25);
constexpr int8_t RESOURCE_G_TRI1 = OPCODE(0x26);
constexpr int8_t RESOURCE_G_DL_PATH = OPCODE(0x27);
constexpr int8_t RESOURCE_G_PUSHCD = OPCODE(0x28);
constexpr int8_t RESOURCE_G_MTX_PATH = OPCODE(0x29);
constexpr int8_t RESOURCE_G_DL_HASH = OPCODE(0x31);
constexpr int8_t RESOURCE_G_VTX_HASH = OPCODE(0x32);
constexpr int8_t RESOURCE_G_MARKER = OPCODE(0x33);
constexpr int8_t RESOURCE_G_INVALTEXCACHE = OPCODE(0x34);
constexpr int8_t RESOURCE_G_BRANCH_Z = OPCODE(0x35);
constexpr int8_t RESOURCE_G_MTX = OPCODE(0x36);
constexpr int8_t RESOURCE_G_TEXRECT_WIDE = OPCODE(0x37);
constexpr int8_t RESOURCE_G_FILLWIDERECT = OPCODE(0x38);

/* GFX Effects */

// RDP Cmd
constexpr int8_t RESOURCE_G_SETGRAYSCALE = OPCODE(0x39);
constexpr int8_t RESOURCE_G_EXTRAGEOMETRYMODE = OPCODE(0x3a);
constexpr int8_t RESOURCE_G_COPYFB = OPCODE(0x3b);
constexpr int8_t RESOURCE_G_IMAGERECT = OPCODE(0x3c);
constexpr int8_t RESOURCE_G_DL_INDEX = OPCODE(0x3d);
constexpr int8_t RESOURCE_G_READFB = OPCODE(0x3e);
constexpr int8_t RESOURCE_G_REGBLENDEDTEX = OPCODE(0x3f);
constexpr int8_t RESOURCE_G_SETINTENSITY = OPCODE(0x40);
constexpr int8_t RESOURCE_G_MOVEMEM_HASH = OPCODE(0x42);
constexpr int8_t RESOURCE_G_LOAD_SHADER = OPCODE(0x43);
