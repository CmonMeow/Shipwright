...
struct RawTexMetadata {
    ...
    std::shared_ptr<Engine::Rendering::Texture> resource;
    Engine::Rendering::TextureType type;
};
...
class Interpreter {
  public:
    Interpreter(Engine::ResourceManager& resources, Engine::ConsoleVariable& variables, GfxDebugger& debugger);
    ~Interpreter();

    void InitializeRenderer(OpenGLPresentation* presentation,
    ...
    void EndFrame();
    bool ViewportMatchesRendererResolution() const;
    ...
    Engine::ResourceManager& mResources;
    Engine::ConsoleVariable& mVariables;
    GfxDebugger& mDebugger;
    RSP* mRsp;
    RDP* mRdp;
    ...
    XYWidthHeight mPresentationViewport{};
    ...
    OpenGLPresentation* mPresentation = nullptr;
