...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/CmonMeow/Desktop/Shipwright/third_party/fetchcontent/stormlib-src"
...
execute_process(
  COMMAND "C:/Users/CmonMeow/.cache/codex-runtimes/codex-primary-runtime/dependencies/native/git/cmd/git.exe" --git-dir=.git show-ref "v9.25"
  WORKING_DIRECTORY "C:/Users/CmonMeow/Desktop/Shipwright/third_party/fetchcontent/stormlib-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v9.25" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v9.25")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v9.25")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v9.25\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/CmonMeow/Desktop/Shipwright/third_party/fetchcontent/stormlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/CmonMeow/Desktop/Shipwright/third_party/fetchcontent/stormlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
